...
public class Arm extends SubsystemBase {
  ...
  public Command armCommand() {
    ...
    return runOnce(() -> m_motor.setVoltage(pidOutput))
        .andThen(runOnce(() -> SmartDashboard.putBoolean("ArmLift", true)))
        .withName("ReachSetPoint");
  }

  public Command armStopCommand() {

    return runOnce(() -> m_motor.setVoltage(0))
        .andThen(runOnce(() -> SmartDashboard.putBoolean("ArmLift", false)))
        .withName("ReachSetPoint");
  }
