...
public final class Constants {
  ...
  public static final int kMotorPort = 10; //0
  public static final int kEncoderAChannel = 8; //0
  public static final int kEncoderBChannel = 9; //1
  public static final int kJoystickPort = 2; //0
